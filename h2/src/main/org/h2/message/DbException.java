...
public class DbException extends RuntimeException {
     ...
     * inside {@link #convert2DbException(java.lang.Throwable)}.
     */
    public static final SQLException SQL_OOME = new SQLException("OutOfMemoryError", "HY000", OUT_OF_MEMORY, new OutOfMemoryError());
    ...
    public static SQLException toSQLException(Throwable e) {
        ...
        return convert2DbException(e).getSQLException();
    }
     ...
     */
    public static DbException convert2DbException(Throwable e) {
        try {
            ...
            try {
                DbException dbException = new DbException(new SQLException("GeneralError", "HY000", GENERAL_ERROR_1, e));
    ...
    public static SQLException getJdbcSQLException(int errorCode, Throwable cause, String... params) {
        String sqlState = ErrorCode.getState(errorCode); // errorCode对应的文本
        String message = translate(sqlState, params);
     ...
     * @return the SQLException object
     */
    public static SQLException getJdbcSQLException(String message,
                                                   String sql,
                                                   String state,
                                                   int errorCode,
                                                   Throwable cause,
