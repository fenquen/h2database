...
public class TestGeometryUtils extends TestBase {
    ...
    private static final byte[][] NON_FINITE = { //
            // XY
            StringUtils.convertHexString2ByteArr("0000000001" //
                    + "0000000000000000" //
                    + "7ff8000000000000"), //
            // XY
            StringUtils.convertHexString2ByteArr("0000000001" //
                    ...
                    + "0000000000000000"), //
            // XYZ
            StringUtils.convertHexString2ByteArr("0080000001" //
                    + "0000000000000000" //
                    + "0000000000000000" //
                    + "7ff8000000000000"), //
            // XYM
            StringUtils.convertHexString2ByteArr("0040000001" //
                    + "0000000000000000" //
                    + "0000000000000000" //
                    + "7ff8000000000000") };
    ...
    private static final byte[] MIXED_WKB = StringUtils.convertHexString2ByteArr(""
            // BOM (BigEndian)
            + "00"
            // Z | LINESTRING
            + "80000002"
    ...
    private void testEmptyPoint() {
        ...
        assertEquals(StringUtils.convertHexString2ByteArr("00000000017ff80000000000007ff8000000000000"), ewkb);
    ...
    private void testSRID() throws Exception {
        ...
        assertEquals(StringUtils.convertHexString2ByteArr(""
                // ******** Geometry collection ********
                // BOM (BigEndian)
                + "00"
